    ...
    footer={
      displayFooter ?? true
        ? [
            <div
              key="footer"
              className="flex flex-col-reverse space-y-2 space-y-reverse sm:flex-row sm:justify-end sm:space-x-2 sm:space-y-0"
            >
              ...
              {displayFooterSubmitButton ?? true ? (
                <button
                  ...
                  type="button"
                  onClick={onSubmit}
                  className="xs:hover:bg-primary-hover focus-visible:ring-primary-400  inline-flex h-9 items-center justify-center rounded-md  bg-primary px-4 py-2 text-sm font-medium text-white text-white shadow transition-colors focus-visible:outline-none focus-visible:ring-1 active:bg-primary disabled:pointer-events-none disabled:opacity-50 sm:hover:bg-primary-hover md:hover:bg-primary-hover"
                >
