...
const sheetVariants = cva(
  [
    "fixed inset-y-0 z-50 h-full w-3/4 gap-4 bg-white p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in sm:max-w-sm",
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Title
    ref={ref}
    className={cn("text-lg font-semibold text-typography-primary", className)}
    {...props}
  />
));
